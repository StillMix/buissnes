      ...
      <div className='loginPopup'>
        ...
        <div className='loginPopup__container'>
          <div className='loginPopup__text'>
            ...
            <p className='loginPopup_text_subtitle'>Пожалуйста, войдите в систему, если вы наш :)</p>
          </div>
          <div className='loginPopup__inputs'>
            <input placeholder='Логин' className='loginPopup_inputs_login input' />
            <input placeholder='Пароль' className='loginPopup_inputs_password input' />
          </div>
        </div>
        <div className='loginPopup__containerBtn'>
          <p className='loginPopup__darkTheme'><span className='loginPopup_darkTheme_icon'><img src={DarkLight} /></span>Темный режим</p>
          <button className='loginPopup__btn'>Войти <span className='loginPopup_btn_img'><img src={AllowRight} /></span></button>
        </div>
      </div>
    </div>
  );
